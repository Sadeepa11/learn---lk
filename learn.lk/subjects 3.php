            ...
            ?>
                ...
                <div class="col-6 mt-5 mb-3" style=" margin-left:35%;">
                    <div class="row">
                        ...
                        <span class="fs-4 text-start "><a class="uk-button btn btn-primary" type="button" href='<?php echo "marks.php?name=" . ($selected_data["name"]); ?>'><i class="bi bi-arrow-bar-right"></i></a></span>
                        </div>
